...
dev_links = [
    {"icon": "🏗️", "title": "開発室", "page": "pages/development_room.py"},
    {"icon": "📊", "title": "プロジェクト\n管理室", "page": "pages/project_management.py"},
    {"icon": "📦", "title": "プロダクト\n管理", "page": "pages/product_management.py"},
    {"icon": "🧪", "title": "A/Bテスト", "page": "pages/ab_testing.py"}
]
...
for idx, link in enumerate(dev_links):
    with dev_cols[idx]:
        if st.button(f"{link['icon']}\n\n{link['title']}", key=f"dev_{idx}", use_container_width=True):
            st.switch_page(link['page'])

# カテゴリ2: プロジェクト運営系
st.markdown("#### 📈 プロジェクト運営・分析")
operation_links = [
    {"icon": "📈", "title": "パフォーマンス", "page": "pages/performance_dashboard.py"},
    {"icon": "🎯", "title": "アトリビューション\n分析", "page": "pages/attribution_analysis.py"},
    {"icon": "🛤️", "title": "カスタマー\nジャーニー", "page": "pages/customer_journey_engine.py"},
    {"icon": "💬", "title": "AIチャット", "page": "pages/realtime_chat.py"}
]
...
marketing_links = [
    {"icon": "🎨", "title": "AI Creative\nStudio", "page": "pages/ai_creative_studio.py"},
    {"icon": "⚡", "title": "リアルタイム\n最適化", "page": "pages/realtime_ad_optimizer.py"},
    {"icon": "🌐", "title": "マルチ\nプラットフォーム", "page": "pages/multi_platform_manager.py"},
    {"icon": "📚", "title": "マニュアル", "page": "pages/user_manual.py"},
    {"icon": "⚙️", "title": "設定", "page": "pages/ai_settings.py"}
]
